...
export default function EmilebilirSuturler() {
    return (
        <div >
            <Navbar />
            ...
            {/* <div style={{ paddingTop: "10px" }} class="main-wrapper">
                    ...
                    <div id="Group_51">
                                ...
                                <img id="pedesente" style={{ height: "300px", width: "300px" }} src={pedesente} />

                                <div id="TEKTEL_steril_ISO_5832_Blm-1_C">
                                    <span>PEDESENTE steril, emilebilir monofilaman cerrahi ameliyat ipliğidir. Sütür polidioksanon'dan mamuldür ve ampirik formülü (-O-CH2-CH2-OCH2-CO-)n. Polidioksanon polimeri antijen ve pirojen değildir, emilim sırasında sadece hafif doku reaksiyonu ortaya çıkar. PEDESENTE sütürler dokuda görüşü sağlamak için polimerizasyon sırasında mor renge (D&C Violet No.2 (C.l. # 60725)) boyanır. Ayrıca, boyanmamış (bej) olarak da mevcuttur.PEDESENTE Avrupa Farmakopesi (EP) ve Amerika Birleşik Devletleri Farmakopesi'nde (USP) emilebilir sentetik sütürler için tanımlanmış gerekliliklerin tümünü karşılar.</span>
                                </div>
