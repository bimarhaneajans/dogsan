...
export default function TarihceSlider() {
  return (
    <div classNanem="gallery-mixed-content-demo" id = "gallery-mixed-content-demo" >
        <a href = "img/img1.jpg" >
      ...
      data-sub-html="<h4>Nature</h4><p>Video by <a target='_blank' href='https://vimeo.com/charliekaye'>Charlie Kaye</a></p>" >
        <img width="300" height="100" class="img-responsive" src="/images/demo/vimeo-video-poster.jpg" />
      </a>
