          ...
          {/* <div id="full-slider-wrapper">
            <div id="layerslider" style="width:100%;height:720px;max-width: 100%;">
              <div className="ls-slide" data-ls="slidedelay:8000;transition2d:4;">
                ...
                <img className="ls-l" style="top:230px;left:690px;white-space: nowrap;" data-ls="offsetxin:50;durationin:2000;delayin:800;offsetxout:50;durationout:1000;parallaxlevel:1;" src="sliderimages/ldoctor.png" alt="" />
                <img className="ls-l" style="top:100px;left:400px;white-space: nowrap;" data-ls="offsetxin:100;durationin:2000;delayin:1200;offsetxout:100;durationout:1000;parallaxlevel:3;" src="sliderimages/gdoctor.png" alt="" />
                ...
                durationout:750;
                skewxout:60;">
                  Prices from <span style="font-family:'Open Sans';font-size:2em;letter-spacing:0px;color:#0eb2e7;">$50</span> for month
                </h6>
              </div>
