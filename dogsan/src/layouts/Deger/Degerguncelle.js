            ...
            <div className="edit-form">
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <RichTextEditor name="Content" id="Content" type="text" style={{ width: "600px" }} value={currentTutorial.baslik} onChange={(Content) => handleInputChange({ target: { value: Content, name: 'Content' } })} />
