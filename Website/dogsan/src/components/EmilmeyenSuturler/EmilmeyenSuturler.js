...
export default function EmilmeyenSuturler() {
    return (
        <div >
            <Navbar />
            ...
            {/* <div style={{ paddingTop: "10px" }} class="main-wrapper">
                    ...
                    <div id="Group_51">
                                ...
                                <img id="pedesente" style={{ height: "300px", width: "300px" }} src={daylon} />

                                <div id="TEKTEL_steril_ISO_5832_Blm-1_C">
                                    <span>DAYLON, uzun zincirli alifatik polimerlerden poliamid den elde edilmiş sentetik ve emilmeyen steril cerrahi monofilaman bir ipliktir. DAYLON mavi(FD&C Blue 2) veya siyah (Hematein Logwood siyah ) renktedir.DAYLON Avrupa Farmakopesi (EP) ve Amerika Birleşik Devletleri Farmakopesi (USP)’de absorbe olmayan cerrahi iplikler için belirtilen gerekliliklerin tümünü karşılar.</span>
                                </div>
